...
if vim.o.background == "dark" then
  ...
  groups = {
    ...
    NormalFloat  = { bg = c.bg, fg = c.fg },
    FloatBorder  = { bg = c.bg, fg = c.line },
    Cursor       = { bg = c.cursor, fg = c.fg },
    CursorColumn = { bg = c.cursor, fg = c.fg },
    TermCursor   = { link = "Cursor" },
    ...
    WinSeparator = { fg = c.line },
    Pmenu        = { fg = c.fg, bg = c.transparent },
    PmenuSel     = { bg = c.selection, fg = c.fg, bold = true },
    PmenuThumb   = { bg = c.fg },
    PmenuMatch   = { fg = c.constant, bold = true },
    ...
    Typedef      = { link = "Keyword" },
    Tag          = { link = "Keyword" },
    Function     = { fg = c.fg, bg = utils.blend(c.definition, c.bg, 0.5), bold = true },
    Title        = { fg = c.fg, bold = true },
    String       = { fg = c.fg, bg = utils.blend(c.string, c.bg, 0.25), italic = false },
    Character    = { link = "String" },
    Number       = { fg = c.constant },
    Boolean      = { fg = c.fg, bg = utils.blend(c.constant, c.bg, 0.25)},
    Float        = { fg = c.constant },
    Constant     = { fg = c.fg, bg = utils.blend(c.constant, c.bg, 0.25)},
    Macro        = { fg = c.constant },
    Comment      = { fg = c.comment, italic = true },
    Todo         = { fg = c.bg, bg = c.hint, bold = true },
    Special      = { fg = c.fg },
